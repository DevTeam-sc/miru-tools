...
from miru_tools.application import ConsoleApplication, await_enter
from miru_tools.model import Function, Module, ModuleFunction
...
class Discoverer:
    ...
    def start(self, session: miru.core.Session, runtime: str, ui: UI) -> None:
