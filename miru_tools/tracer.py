...
def main() -> None:
    ...
    class TracerApplication(ConsoleApplication, UI):
        ...
        def on_script_created(self, script: miru.core.Script) -> None:
...
class Tracer:
    def __init__(
        ...
        self._script: Optional[miru.core.Script] = None
        self._message_handler = None
        self._agent = None
        self._init_scripts = init_scripts
        self._log_handler = log_handler

    def start_trace(self, session: miru.core.Session, stage, parameters, runtime, ui: UI) -> None:
        ...
        source = (
            (data_dir / "tracer_agent.js").read_text(encoding="utf-8").replace("/agent.js", "/miru/tracer/agent.js", 1)
        )
...
class Repository:
    ...
    def _create_stub_instruction_handler(self, target: TraceTarget, decorate: bool) -> str:
        return """\
/*
 * Auto-generated by Miru.
 *
 * For full API reference, see: https://miru.re/docs/javascript-api/
 */
...
""" % {
    ...
    def _create_stub_native_handler(self, target: TraceTarget, decorate: bool) -> str:
        ...
        return """\
/*
 * Auto-generated by Miru. Please modify to match the signature of %(display_name)s.
...
class FileRepository(Repository):
    ...
    def _ensure_monitor(self, handler_file: Path) -> None:
        ...
        if monitor is None:
            monitor = miru.FileMonitor(str(handler_dir))
